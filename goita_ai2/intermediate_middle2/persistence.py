...
DEFAULT_ADAPTIVE_VALUE_PATH = "results/background_search_value_intermediate_middle2.json"
ADAPTIVE_VALUE_FILENAME = "background_search_value_intermediate_middle2.json"
...
def resolve_adaptive_value_storage(
    ...
    *,
    ...
    explicit_path = str(
        environ.get("GOITA_AI_INTERMEDIATE_MIDDLE2_ADAPTIVE_VALUE_PATH", "") or ""
    ).strip()
    if explicit_path:
