...
from goita_ai2.intermediate_middle2.generic_response_store import (
...
from goita_ai2.intermediate_middle2.human_response_dictionary import (
    human_response_dictionary,
)
from goita_ai2.intermediate_middle2.search_cache import _digest_payload
...
class GenericResponsePatternMixin:
    ...
    GENERIC_RESPONSE_HUMAN_TARGETED_LIVE_ENABLED = False
    GENERIC_RESPONSE_HUMAN_TARGETED_LIVE_MIN_VALUE_DELTA = 100.0
