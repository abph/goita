...
class BackgroundSearchMixin:
    ...
    def _finish_background_search(
        ...
        *,
        ...
        from goita_ai2.intermediate_middle2.telemetry import record_ai_background_finish
    ...
    def prefetch_next_turn(self, state) -> bool:
        ...
        from goita_ai2.intermediate_middle2.telemetry import record_ai_background_prefetch
    ...
    def retain_background_search_for_action(self, action: Action) -> bool:
        ...
        from goita_ai2.intermediate_middle2.telemetry import record_ai_background_paths
