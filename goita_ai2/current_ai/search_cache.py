...
_SEARCH_POLICY_ATTRIBUTES = (
    "ALLY_REACH_HANDOFF_ENABLED",
    "ALLY_REACH_HANDOFF_SAMPLE_COUNT",
    "ALLY_REACH_HANDOFF_MIN_SAMPLES",
    "ALLY_REACH_HANDOFF_MIN_EFFECTIVE_SAMPLES",
    "ALLY_REACH_HANDOFF_MAX_SECONDS",
    "ALLY_REACH_HANDOFF_MIN_CHANCE",
    "ALLY_REACH_HANDOFF_MIN_ADVANTAGE",
    ...
    "GENERIC_RESPONSE_TACTICAL_PRIORITY_ENABLED",
    "GENERIC_RESPONSE_TACTICAL_PAIRED_COMPARISON_ENABLED",
    "GENERIC_RESPONSE_HUMAN_TARGETED_PRIORITY_ENABLED",
    ...
    "GENERIC_RESPONSE_TACTICAL_PRIORITY_MIN_OBSERVATIONS",
    "GENERIC_RESPONSE_TACTICAL_PRIORITY_MIN_DOMINANCE",
    ...
    "SHI_INSERTION_COMMON_ATTACK_WEIGHT",
    "SHI_INSERTION_LOST_RECEIVE_PENALTY",
