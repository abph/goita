...
(async () => {
  ...
  try {
    ...
    assert.equal(await page.locator('#lobbyPublicRoomsTab').getAttribute('aria-selected'),'true');
    await page.locator('#lobbyPrivateRoomsTab').click();
    ...
    assert.equal(await page.locator('#lobbyPrivateRoomsTab').getAttribute('aria-selected'),'true');
    await page.locator('#lobbyPublicRoomsTab').click();
    assert.equal(await page.locator('#lobbyPublicRoomsPanel').isVisible(),true);
