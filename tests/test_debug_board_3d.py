...
def test_3d_board_is_available_in_private_and_debug_rooms() -> None:
    ...
    assert 'import("/static/board3d.js?v=20260821b")' in html
    ...
    assert html.count(">どこかの集会室</button>") == 2
    ...
    assert '"どこかの集会室": "某处的活动室"' in chinese
    assert '"どこかの集会室": "A Meeting Room Somewhere"' in english
